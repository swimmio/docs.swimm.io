...
## Adding a playlist to a Doc or another playlist

In the Editor, typing "/" anywyere reveals the editor options.<br/>
Select "Playlist". Navigate and pick the playlist you would like to link to.