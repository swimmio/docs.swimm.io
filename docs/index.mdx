...
:::tip The Current Version Of Swimm Is <SwimmVersion />

You can pull feeds from our <Link to="/changelog">changelog</Link> to stay up-to-date on bug fixes and new features.

<FeedSelector />

:::

Major new features are described in-depth on our <Link href="https://swimm.io/blog">main blog</Link>.
