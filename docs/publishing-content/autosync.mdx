...
## What kinds of things can Swimm automaticaly sync?
...
Additionally, when you use <Link to="/docs/creating-content/smart-tokens">Smart Text & Paths</Link>
...
following things happen:
 ...
 exported (confluence, notion, etc) docunentation if you automate updatating them
 from your builds.
