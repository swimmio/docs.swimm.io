...
Swimm is a platform for Continuous Documentation platform, helping developers create, find, and maintain documentation. With Swimm, developers 
...
Swimm is using it to connect with your GitHub repositories in order to access relevant documents 
...
Swimm helps its users maintain up to date documentation by integrating their CI. This can be done 
